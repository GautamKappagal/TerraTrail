...
export default function AddPlaceModal({ open, latLng, onClose, onSave }) {
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-2xl overflow-hidden rounded-2xl border border-white/10 bg-slate-950/60 shadow-glass backdrop-blur-xl">
        <div className="flex items-start justify-between gap-4 border-b border-white/10 px-5 py-4">
          <div className="min-w-0">
            ...
            <p className="mt-1 text-sm text-slate-300">
              Drop a memory on the map — make it beautiful.
            </p>
          </div>
          <button
            type="button"
        ...
        <div className="grid gap-4 px-5 py-4 md:grid-cols-5">
          <div className="md:col-span-3">
            <label className="block text-sm text-slate-200">
              Place name <span className="text-fuchsia-300">*</span>
            </label>
            <input
              value={name}
            ...
            <div className="mt-3 grid gap-3 sm:grid-cols-2">
              <div>
                <label className="block text-sm text-slate-200">Travel date</label>
                <input
                  type="date"
                  value={date}
              ...
              <div>
                <label className="block text-sm text-slate-200">Image URL</label>
                <input
                  value={imageUrl}
